...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(MiniStoreException.class)
    public ResponseEntity<CustomError> handleException(MiniStoreException ex){
        return new ResponseEntity<>(ex.getCustomError(), ex.getStatus());
    }
}
